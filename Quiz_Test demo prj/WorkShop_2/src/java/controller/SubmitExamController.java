 ...
 * @author vomin
 */
@WebServlet(name = "SubmitExamController", urlPatterns = {"/SubmitExamController"})
    ...
    // Lấy danh sách câu hỏi từ DAO
        try {
            ...
            for (QuestionDTO question : questions) {
                // Lấy câu trả lời của người dùng cho từng câu hỏi
                String userAnswer = request.getParameter("answer" + question.getQuestionId());
